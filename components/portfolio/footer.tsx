...
export function Footer() {
  ...
  // Social links — all read from the Supabase `profile` table
  const socialLinks = [
    {
      name: "GitHub",
      href: profile?.github ?? "#",
    ...
    {
      name: "Facebook",
      // `facebook` column in the profile table — set it in Admin → Profile
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-4">
            <a href="#home" className="text-2xl font-bold text-gradient inline-block">
              {profile?.name
